...
o_nav.o_nav_title_classes = 'lrv-js-MobileHeightToggle-trigger lrv-u-padding-lr-1 lrv-u-margin-tb-00 lrv-u-padding-t-1 lrv-u-padding-t-050@tablet lrv-u-padding-b-050 lrv-u-width-100p@mobile-max a-icon-after a-icon-arrow-down a-icon-after:margin-l-auto a-icon-after-remove@tablet a-icon-invert lrv-u-cursor-pointer lrv-u-font-family-primary lrv-u-font-weight-bold lrv-u-font-size-20';
...
module.exports = {
	footer_menu_classes: "lrv-a-grid lrv-a-cols3@tablet lrv-u-background-black lrv-u-color-white",
	o_navs: [
		o_nav,
		o_nav,
		o_nav
