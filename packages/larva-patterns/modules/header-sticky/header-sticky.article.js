...
read_next.c_span.c_span_classes = 'lrv-u-whitespace-nowrap lrv-u-text-transform-uppercase a-font-body-m lrv-u-font-weight-700';
read_next.c_title.c_title_link_classes = 'lrv-a-unstyle-link lrv-u-whitespace-nowrap a-font-body-m lrv-u-letter-spacing-n004';
...
header_sticky.expandable_search_sticky.expandable_search_inner_classes = header_sticky.expandable_search_sticky.expandable_search_inner_classes.replace('lrv-a-glue--r-0','lrv-a-glue--l-0');
header_sticky.expandable_search_sticky.expandable_search_classes += ' sticky-expandable';
