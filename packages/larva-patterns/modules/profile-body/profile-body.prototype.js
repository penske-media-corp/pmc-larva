...
c_dek.c_dek_markup = '';
c_dek.c_dek_classes = 'lrv-u-font-size-28 lrv-u-font-weight-light lrv-u-font-family-body lrv-u-margin-tb-1';
...
module.exports = {
	...
	profile_body_content_markup: '<b>Perfection</b> is rarely achieved in movies, but this heaven-sent concert doc hits the sweet spot. Over two days in January 1972, the Queen of Soul, Aretha Franklin — she was 29 at the time — sweeps into the New Temple Missionary Baptist Church in Watts in front of a congregation and testifies to God in song. The blessed thing took nearly half a century to come out because director Sydney Pollack failed to sync the image with the sound. Then digital angels stepped in, and glory, glory, hallelujah!'
};
