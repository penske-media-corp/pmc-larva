...
const c_logo_prototype = require( '@penskemediacorp/larva-patterns/components/c-logo/c-logo.prototype' );
...
o_email_capture_form.c_email_field.c_email_field_input_classes +=
	' lrv-u-border-a-0 lrv-u-font-size-14 lrv-u-width-100p lrv-u-height-100p lrv-u-padding-lr-1 lrv-u-padding-tb-050';
...
o_email_capture_form.c_button.c_button_classes +=
	' lrv-u-background-color-black lrv-u-color-white lrv-u-text-align-center lrv-u-padding-a-050 lrv-u-font-weight-bold';
...
o_email_capture_form.c_email_field.c_email_field_classes = ' lrv-u-margin-r-075 lrv-u-width-100p lrv-u-border-a-1';
o_email_capture_form.o_email_capture_form_classes = 'lrv-u-margin-t-1 lrv-u-width-100p';
...
module.exports = {
	newsletter_classes:
		'lrv-u-padding-tb-2 lrv-u-padding-lr-2 lrv-u-flex lrv-u-flex-direction-column',
