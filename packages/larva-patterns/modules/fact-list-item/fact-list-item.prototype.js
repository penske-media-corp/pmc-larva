...
module.exports = {
	fact_list_item_classes: [
		...
		'lrv-u-margin-b-1',
		'lrv-u-padding-b-1',
		'lrv-a-term-content__fact-list-item',
	].join( ' ' ),
	fact_list_item_dd_classes: 'lrv-u-margin-l-00 lrv-a-term-content__fact-list-dd',
	...
	fact_list_item_dt_classes: 'lrv-u-font-weight-bold lrv-a-term-content__fact-list-dt',
