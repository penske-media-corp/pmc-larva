...
o_nav.o_nav_classes = 'lrv-u-flex lrv-u-justify-content-center a-hidden@desktop-xl-max';
o_nav.o_nav_list_classes += ' lrv-u-flex lrv-a-space-children-horizontal a-space-children--8 lrv-u-align-items-center lrv-u-a-unstyle-list';
...
module.exports = {
	...
	profile_header_top_classes: 'u-background-light-desaturated-magenta lrv-u-color-white',
	...
	profile_header_nav_outer_classes: 'lrv-u-background-color-grey-light lrv-u-padding-tb-050 a-hidden@desktop-and-tablet-only lrv-u-border-t-1 lrv-u-border-color-white',
	o_nav: o_nav,
	o_select_nav_outer_class: 'a-glue@tablet lrv-a-glue--r-0 lrv-a-glue--t-0 lrv-u-text-align-center@mobile-max',
