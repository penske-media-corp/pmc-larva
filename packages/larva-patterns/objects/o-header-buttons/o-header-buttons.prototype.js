...
const c_button_subscribe = require( '../../components/c-button/c-button.prototype' );
...
c_login_link.c_link_classes = 'subscriber-login-link lrv-a-unstyle-link lrv-u-text-transform-uppercase lrv-u-font-family-body lrv-u-font-size-12 lrv-u-font-size-8@mobile-max  lrv-u-color-brand-primary:hover lrv-u-border-b-1 lrv-u-border-color-white lrv-u-border-color-brand-primary:hover';

const c_subscribe_link = clonedeep( c_button_subscribe );
c_subscribe_link.c_button_text = 'Subscribe';
c_subscribe_link.c_button_classes = 'subscribe-link cx-dynamic-link lrv-a-unstyle-button lrv-a-unstyle-link lrv-u-text-transform-uppercase lrv-u-font-family-body lrv-u-font-size-12 lrv-u-font-size-8@mobile-max  lrv-u-color-brand-primary:hover lrv-u-border-b-1 lrv-u-border-color-white lrv-u-border-color-brand-primary:hover';
...
module.exports = {
	...
	hide_flyout_classes: 'lrv-a-hidden',
	subscribe_wrapper_classes: 'lrv-u-border-l-00@mobile-max lrv-u-border-l-1 lrv-u-padding-l-1 lrv-u-padding-tb-025 lrv-u-margin-tb-025',
	login_wrapper_classes: 'lrv-u-border-l-00@mobile-max lrv-u-border-l-1 lrv-u-padding-l-1 lrv-u-padding-tb-025  lrv-u-margin-tb-025',
