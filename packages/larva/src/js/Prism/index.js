...
var _self = 'undefined' != typeof window ? window : 'undefined' != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {},
	Prism = ( function( u ) {
		var c = /\blang(?:uage)?-([\w-]+)\b/i,
			a = 0;var _ = {manual: u.Prism && u.Prism.manual, disableWorkerMessageHandler: u.Prism && u.Prism.disableWorkerMessageHandler, util: {encode: function( e ) {
			...
			var t, a,
				i = _.util.type( e );switch ( r = r || {}, i ) {
			case 'Object':if ( a = _.util.objId( e ), r[a] ) {
				return r[a];
			} for ( var o in t = {}, r[a] = t, e ) {
					e.hasOwnProperty( o ) && ( t[o] = n( e[o], r ) );
				} return t;case 'Array':return a = _.util.objId( e ), r[a] ? r[a] : ( t = [], r[a] = t, e.forEach( function( e, a ) {
				t[a] = n( e, r );
			} ), t );default:return e;
			}
		}}, languages: {extend: function( e, a ) {
			var n = _.util.clone( _.languages[e] );for ( var r in a ) {
				n[r] = a[r];
			} return n;
			...
			} var s = r[n];return r[n] = i, _.languages.DFS( _.languages, function( e, a ) {
				a === s && e != n && ( this[e] = i );
			} ), i;
		}, DFS: function e( a, n, r, t ) {
			t = t || {};var i = _.util.objId;for ( var o in a ) {
				if ( a.hasOwnProperty( o ) ) {
					n.call( a, o, a[o], r || o );var l = a[o],
						s = _.util.type( l );'Object' !== s || t[i( l )] ? 'Array' !== s || t[i( l )] || ( t[i( l )] = ! 0, e( l, n, o, t ) ) : ( t[i( l )] = ! 0, e( l, n, null, t ) );
				}
			}
		}}, plugins: {}, highlightAll: function( e, a ) {
			_.highlightAllUnder( document, e, a );
		}, highlightAllUnder: function( e, a, n ) {
			var r = {callback: n, selector: 'code[class*="language-"], [class*="language-"] code, code[class*="lang-"], [class*="lang-"] code'};_.hooks.run( 'before-highlightall', r );for ( var t, i = e.querySelectorAll( r.selector ), o = 0;t = i[o++]; ) {
			...
			var r = ( function( e ) {
				...
				t = _.languages[r];e.className = e.className.replace( c, '' ).replace( /\s+/g, ' ' ) + ' language-' + r;var i = e.parentNode;i && 'pre' === i.nodeName.toLowerCase() && ( i.className = i.className.replace( c, '' ).replace( /\s+/g, ' ' ) + ' language-' + r );var o = {element: e, language: r, grammar: t, code: e.textContent};function l( e ) {
			...
			var r = {code: e, grammar: a, language: n};return _.hooks.run( 'before-tokenize', r ), r.tokens = _.tokenize( r.code, r.grammar ), _.hooks.run( 'after-tokenize', r ), L.stringify( _.util.encode( r.tokens ), r.language );
		}, matchGrammar: function( e, a, n, r, t, i, o ) {
			for ( var l in n ) {
				if ( n.hasOwnProperty( l ) && n[l] ) {
					var s = n[l];s = Array.isArray( s ) ? s : [ s ];for ( var u = 0;u < s.length;++u ) {
						if ( o && o == l + ',' + u ) {
							return;
						} var c = s[u],
							g = c.inside,
						...
						}c = c.pattern || c;for ( var y = r, v = t;y < a.length;v += a[y].length, ++y ) {
							var k = a[y];if ( a.length > e.length ) {
								return;
							} if ( ! ( k instanceof L ) ) {
								if ( h && y != a.length - 1 ) {
									...
									f && ( d = x[1] ? x[1].length : 0 );w = ( b = x.index + d ) + ( x = x[0].slice( d ) ).length;var N = k.slice( 0, b ),
										S = k.slice( w ),
										C = [ y, j ];N && ( ++y, v += N.length, C.push( N ) );var E = new L( l, g ? _.tokenize( x, g ) : x, m, x, h );if ( C.push( E ), S && C.push( S ), Array.prototype.splice.apply( a, C ), 1 != j && _.matchGrammar( e, a, n, y, v, ! 0, l + ',' + u ), i ) {
										break;
									}
								} else if ( i ) {
									break;
			...
			var n = _.hooks.all;n[e] = n[e] || [], n[e].push( a );
		}, run: function( e, a ) {
			var n = _.hooks.all[e];if ( n && n.length ) {
				for ( var r, t = 0;r = n[t++]; ) {
					r( a );
				}
			}
		}}, Token: L};function L( e, a, n, r, t ) {
			...
			} var n = {type: e.type, content: L.stringify( e.content, a ), tag: 'span', classes: [ 'token', e.type ], attributes: {}, language: a};if ( e.alias ) {
				var r = Array.isArray( e.alias ) ? e.alias : [ e.alias ];Array.prototype.push.apply( n.classes, r );
			}_.hooks.run( 'wrap', n );var t = Object.keys( n.attributes ).map( function( e ) {
				return e + '="' + ( n.attributes[e] || '' ).replace( /"/g, '&quot;' ) + '"';
			} ).join( ' ' );return '<' + n.tag + ' class="' + n.classes.join( ' ' ) + '"' + ( t ? ' ' + t : '' ) + '>' + n.content + '</' + n.tag + '>';
		}, ! u.document ) {
			return u.addEventListener && ( _.disableWorkerMessageHandler || u.addEventListener( 'message', function( e ) {
				var a = JSON.parse( e.data ),
					n = a.language,
					r = a.code,
					t = a.immediateClose;u.postMessage( _.highlight( r, _.languages[n], n ) ), t && u.close();
			}, ! 1 ) ), _;
		} var e = document.currentScript || [].slice.call( document.getElementsByTagName( 'script' ) ).pop();if ( e && ( _.filename = e.src, e.hasAttribute( 'data-manual' ) && ( _.manual = ! 0 ) ), ! _.manual ) {
			function n() {
