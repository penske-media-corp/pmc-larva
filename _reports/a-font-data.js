...
const fontNamesWithOnePlus = Object.keys( fontNamesWithCounts ).reduce( ( acc, curr ) => {
	if ( fontNamesWithCounts[curr] > 1 ) acc[curr] = fontNamesWithCounts[curr]
	return acc;
 }, {});

const fontNamesUsedOnce = Object.keys( fontNamesWithCounts ).reduce( ( acc, curr ) => {
	if ( fontNamesWithCounts[curr] === 1 ) acc.push( curr );
	return acc;
}, []);

const fontNamesUsedThricePlus = Object.keys( fontNamesWithCounts ).reduce( ( acc, curr ) => {
